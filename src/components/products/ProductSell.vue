            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" v-model="selectedProduct" @change="productSelected">
                        ...
                        <option v-for="product in getProducts" :value="product.key" :disabled="product.count==0">{{product.title}}</option>
                    </select>
                </div>
                ...
                <hr>
                <button @click="save" :disabled="saveDisabled" class="btn btn-primary">Kaydet</button>
            </div>
        </div>
    </div>
</div>
